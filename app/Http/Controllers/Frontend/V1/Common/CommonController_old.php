...
class CommonController extends Controller
{
    ...
    public function consultation(Request $request)
    {
        ...
        // else if(array_key_exists('limit',$params) || array_key_exists('offset',$params)
        // array_key_exists('offset',$params) || array_key_exists('offset',$params)){
        ...
        //        ->shuffle();
        // }
        // else if(isset($params['limit']) && isset($params['offset']) ){
        //     $data['totalConsultant'] = $totalConsultant;
        //     $data['offset'] = $params['offset'];
        //     $data['limit'] = $params['limit'];
        //     $data['list'] = $consultant
        ...
        // Execute the query and get the consultants
//         $consultants = $consultant->get();

//         $consultants = $consultants->shuffle();

// // Apply pagination and return the result
//         if (isset($params['limit'])) {
//             if (isset($params['offset'])) {
//                 $data['totalConsultant'] = $consultants->count();
//                 $data['offset'] = $params['offset'];
//                 $data['limit'] = $params['limit'];
